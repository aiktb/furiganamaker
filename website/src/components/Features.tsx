...
function FeatureItem({ title, description, icon }: FeatureItemProps) {
  return (
    <div className="animeRising animeRising flex w-full flex-col gap-4 rounded-lg border border-slate-700 bg-slate-800 p-7 transition duration-300 hover:-translate-y-2 hover:bg-slate-700 md:w-96 xl:p-12">
