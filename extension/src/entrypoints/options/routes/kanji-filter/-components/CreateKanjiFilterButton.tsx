  ...
  return (
    <>
      <button
        ...
        className="playwright-kanji-filter-add-new-rule-btn flex w-40 cursor-pointer items-center justify-center gap-1 overflow-hidden text-ellipsis whitespace-nowrap rounded-md bg-slate-950/5 px-1.5 py-2 text-slate-800 transition hover:text-sky-500 sm:px-3 dark:bg-white/5 dark:text-white"
      >
