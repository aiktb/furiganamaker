  ...
  return (
    <>
      <button
        ...
        className="playwright-kanji-filter-quick-create-btn flex w-40 cursor-pointer items-center justify-center gap-1 overflow-hidden text-ellipsis whitespace-nowrap rounded-md bg-sky-600 px-1.5 py-2 text-white transition hover:bg-sky-500 sm:px-3"
      >
          ...
          <DialogPanel className="w-full min-w-[20rem] max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-slate-900">
            ...
            <Textarea
              ...
              className={cn(
                ...
                "resize-y focus:not-data-focus:outline-none data-focus:outline-2 data-focus:outline-sky-500 data-focus:-outline-offset-2",
              )}
              rows={3}
            />
